<template>
  <div :class="cn('globe-root', $props.class)">
    <canvas
      ref="globeCanvasRef"
      class="globe-canvas"
...
<style scoped>
.globe-root { position: relative; width: 100%; }
.globe-canvas { width: 100%; height: 100%; display: block; opacity: 0; transition: opacity 1s ease-in-out; contain: layout paint size; }
</style>